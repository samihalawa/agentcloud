...
const Metadata = Object.seal(Object.freeze(Object.preventExtensions({
	...
	[Permissions.REMOVE_TEAM_MEMBER]: { title: 'Remove Team Member', label: 'Remove Member', desc: 'Ability to remove a team member' },

	[Permissions.CREATE_APP]: { title: 'Create App', label: 'Create App', desc: 'Ability to create an app' },
	[Permissions.EDIT_APP]: { title: 'Edit App', label: 'Edit App', desc: 'Ability to edit an app' },
	[Permissions.DELETE_APP]: { title: 'Delete App', label: 'Delete App', desc: 'Ability to delete an app', parent: Permissions.ORG_OWNER},

	[Permissions.CREATE_DEPLOYMENT]: { title: 'Create Deployment', label: 'Create Deployment', desc: 'Ability to create a deployment' },
	[Permissions.EDIT_DEPLOYMENT]: { title: 'Edit Deployment', label: 'Edit Deployment', desc: 'Ability to edit a deployment' },
	[Permissions.DELETE_DEPLOYMENT]: { title: 'Delete Deployment', label: 'Delete Deployment', desc: 'Ability to delete a deployment' },

	[Permissions.CREATE_AGENT]: { title: 'Create Agent', label: 'Create Agent', desc: 'Ability to create an agent' },
	[Permissions.EDIT_AGENT]: { title: 'Edit Agent', label: 'Edit Agent', desc: 'Ability to edit an agent' },
	[Permissions.DELETE_AGENT]: { title: 'Delete Agent', label: 'Delete Agent', desc: 'Ability to delete an agent' },

	[Permissions.CREATE_MODEL]: { title: 'Create Model', label: 'Create Model', desc: 'Ability to create a model' },
	...
	[Permissions.DELETE_TASK]: { title: 'Delete Task', label: 'Delete Task', desc: 'Ability to delete a task' },

	[Permissions.CREATE_TOOL]: { title: 'Create Tool', label: 'Create Tool', desc: 'Ability to create a tool' },
	[Permissions.EDIT_TOOL]: { title: 'Edit Tool', label: 'Edit Tool', desc: 'Ability to edit a tool' },
	[Permissions.DELETE_TOOL]: { title: 'Delete Tool', label: 'Delete Tool', desc: 'Ability to delete a tool' },
	[Permissions.DELETE_TOOL]: { title: 'Delete Tool', label: 'Delete Tool', desc: 'Ability to delete a tool' },
	...
	[Permissions.UPLOAD_ASSET]: { title: 'Upload Asset', label: 'Upload Asset', desc: 'Ability to upload an asset' },
	[Permissions.DELETE_ASSET]: { title: 'Delete Asset', label: 'Delete Asset', desc: 'Ability to delete an asset' },
